...
public class ViewShared extends android.support.v7.app.AppCompatActivity {
    String ListID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewshared);
        ...
        new ViewShared.ViewListAsync().execute(ListID);
    }
    ...
    public void updateList(View v){
        ...
        new ViewShared.UpdateListAsync().execute(updater);
